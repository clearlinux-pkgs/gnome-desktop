...
Version  : 3.22.0
Release  : 2
URL      : https://download.gnome.org/core/3.22/3.22.0/sources/gnome-desktop-3.22.0.tar.xz
Source0  : https://download.gnome.org/core/3.22/3.22.0/sources/gnome-desktop-3.22.0.tar.xz
...
%prep
%setup -q -n gnome-desktop-3.22.0
