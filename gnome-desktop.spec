...
Version  : 42.3
Release  : 72
URL      : https://download.gnome.org/sources/gnome-desktop/42/gnome-desktop-42.3.tar.xz
Source0  : https://download.gnome.org/sources/gnome-desktop/42/gnome-desktop-42.3.tar.xz
...
%prep
%setup -q -n gnome-desktop-42.3
cd %{_builddir}/gnome-desktop-42.3
%patch1 -p1
%patch2 -p1
%patch3 -p1
pushd ..
cp -a gnome-desktop-42.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657745263
...
cp %{_builddir}/gnome-desktop-42.3/COPYING %{buildroot}/usr/share/package-licenses/gnome-desktop/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/gnome-desktop-42.3/COPYING-DOCS %{buildroot}/usr/share/package-licenses/gnome-desktop/4f485ab7059ac53d9e3818278ad82217ce976a36
cp %{_builddir}/gnome-desktop-42.3/COPYING.LIB %{buildroot}/usr/share/package-licenses/gnome-desktop/ba8966e2473a9969bdcab3dc82274c817cfd98a1
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/glibc-hwcaps/x86-64-v3/libgnome-bg-4.so.1
/usr/lib64/glibc-hwcaps/x86-64-v3/libgnome-bg-4.so.1.2.3
/usr/lib64/glibc-hwcaps/x86-64-v3/libgnome-desktop-3.so.19
/usr/lib64/glibc-hwcaps/x86-64-v3/libgnome-desktop-3.so.19.3.0
/usr/lib64/glibc-hwcaps/x86-64-v3/libgnome-desktop-4.so.1
/usr/lib64/glibc-hwcaps/x86-64-v3/libgnome-desktop-4.so.1.2.3
/usr/lib64/glibc-hwcaps/x86-64-v3/libgnome-rr-4.so.1
/usr/lib64/glibc-hwcaps/x86-64-v3/libgnome-rr-4.so.1.2.3
/usr/lib64/libgnome-bg-4.so.1
/usr/lib64/libgnome-bg-4.so.1.2.3
/usr/lib64/libgnome-desktop-3.so.19
/usr/lib64/libgnome-desktop-3.so.19.3.0
/usr/lib64/libgnome-desktop-4.so.1
/usr/lib64/libgnome-desktop-4.so.1.2.3
/usr/lib64/libgnome-rr-4.so.1
/usr/lib64/libgnome-rr-4.so.1.2.3
