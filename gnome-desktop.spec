...
Source0  : https://download.gnome.org/sources/gnome-desktop/44/gnome-desktop-44.1.tar.xz
...
%prep
%setup -q -n gnome-desktop-44.1
cd %{_builddir}/gnome-desktop-44.1
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
pushd ..
cp -a gnome-desktop-44.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726763570
...
export GOAMD64=v2
meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dinstalled_tests=true  builddir
ninja -v -C builddir
GOAMD64=v3
CFLAGS="$CFLAGS -march=x86-64-v3 -Wl,-z,x86-64-v3 " CXXFLAGS="$CXXFLAGS -march=x86-64-v3 -Wl,-z,x86-64-v3 " LDFLAGS="$LDFLAGS -march=x86-64-v3 " meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dinstalled_tests=true  builddiravx2
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libgnome-bg-4.so.2.1.1
/V3/usr/lib64/libgnome-desktop-3.so.20.0.0
/V3/usr/lib64/libgnome-desktop-4.so.2.1.1
/V3/usr/lib64/libgnome-rr-4.so.2.1.1
/usr/lib64/libgnome-bg-4.so.2
/usr/lib64/libgnome-bg-4.so.2.1.1
/usr/lib64/libgnome-desktop-3.so.20
/usr/lib64/libgnome-desktop-3.so.20.0.0
/usr/lib64/libgnome-desktop-4.so.2
/usr/lib64/libgnome-desktop-4.so.2.1.1
/usr/lib64/libgnome-rr-4.so.2
/usr/lib64/libgnome-rr-4.so.2.1.1
