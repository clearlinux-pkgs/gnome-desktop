...
Source0  : https://download.gnome.org/sources/gnome-desktop/3.30/gnome-desktop-3.30.1.tar.xz
...
Requires: gnome-desktop-bin = %{version}-%{release}
Requires: gnome-desktop-data = %{version}-%{release}
...
%prep
%setup -q -n gnome-desktop-3.30.1
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1537943962
