...
%prep
%setup -q -n gnome-desktop-42.2
cd %{_builddir}/gnome-desktop-42.2
%patch1 -p1
%patch2 -p1
%patch3 -p1
pushd ..
cp -a gnome-desktop-42.2 buildavx2
popd
...
cp %{_builddir}/gnome-desktop-42.2/COPYING %{buildroot}/usr/share/package-licenses/gnome-desktop/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/gnome-desktop-42.2/COPYING-DOCS %{buildroot}/usr/share/package-licenses/gnome-desktop/4f485ab7059ac53d9e3818278ad82217ce976a36
cp %{_builddir}/gnome-desktop-42.2/COPYING.LIB %{buildroot}/usr/share/package-licenses/gnome-desktop/ba8966e2473a9969bdcab3dc82274c817cfd98a1
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libgnome-bg-4.so.1.2.2
