...
Version  : 43.1
Release  : 85
URL      : https://download.gnome.org/sources/gnome-desktop/43/gnome-desktop-43.1.tar.xz
Source0  : https://download.gnome.org/sources/gnome-desktop/43/gnome-desktop-43.1.tar.xz
...
%prep
%setup -q -n gnome-desktop-43.1
cd %{_builddir}/gnome-desktop-43.1
%patch1 -p1
%patch2 -p1
%patch3 -p1
pushd ..
cp -a gnome-desktop-43.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674236700
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libgnome-bg-4.so.2.0.2
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libgnome-desktop-4.so.2.0.2
/usr/lib64/glibc-hwcaps/x86-64-v3/libgnome-rr-4.so.2
/usr/lib64/glibc-hwcaps/x86-64-v3/libgnome-rr-4.so.2.0.2
/usr/lib64/libgnome-bg-4.so.2
/usr/lib64/libgnome-bg-4.so.2.0.2
/usr/lib64/libgnome-desktop-3.so.20
/usr/lib64/libgnome-desktop-3.so.20.0.0
/usr/lib64/libgnome-desktop-4.so.2
/usr/lib64/libgnome-desktop-4.so.2.0.2
/usr/lib64/libgnome-rr-4.so.2
/usr/lib64/libgnome-rr-4.so.2.0.2
