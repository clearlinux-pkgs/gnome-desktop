...
%prep
%setup -q -n gnome-desktop-42.4
cd %{_builddir}/gnome-desktop-42.4
%patch1 -p1
%patch2 -p1
%patch3 -p1
pushd ..
cp -a gnome-desktop-42.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659970410
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libgnome-bg-4.so.1.2.4
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libgnome-desktop-4.so.1.2.4
/usr/lib64/glibc-hwcaps/x86-64-v3/libgnome-rr-4.so.1
/usr/lib64/glibc-hwcaps/x86-64-v3/libgnome-rr-4.so.1.2.4
/usr/lib64/libgnome-bg-4.so.1
/usr/lib64/libgnome-bg-4.so.1.2.4
/usr/lib64/libgnome-desktop-3.so.19
/usr/lib64/libgnome-desktop-3.so.19.3.0
/usr/lib64/libgnome-desktop-4.so.1
/usr/lib64/libgnome-desktop-4.so.1.2.4
/usr/lib64/libgnome-rr-4.so.1
/usr/lib64/libgnome-rr-4.so.1.2.4
