...
Version  : 3.28.1
Release  : 20
URL      : https://download.gnome.org/sources/gnome-desktop/3.28/gnome-desktop-3.28.1.tar.xz
Source0  : https://download.gnome.org/sources/gnome-desktop/3.28/gnome-desktop-3.28.1.tar.xz
...
%prep
%setup -q -n gnome-desktop-3.28.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1523463880
