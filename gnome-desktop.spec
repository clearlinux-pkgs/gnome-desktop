...
%prep
%setup -q -n gnome-desktop-3.38.0
cd %{_builddir}/gnome-desktop-3.38.0
%patch1 -p1
%patch2 -p1
%patch3 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600283870
...
cp %{_builddir}/gnome-desktop-3.38.0/COPYING %{buildroot}/usr/share/package-licenses/gnome-desktop/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/gnome-desktop-3.38.0/COPYING-DOCS %{buildroot}/usr/share/package-licenses/gnome-desktop/4f485ab7059ac53d9e3818278ad82217ce976a36
cp %{_builddir}/gnome-desktop-3.38.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/gnome-desktop/ba8966e2473a9969bdcab3dc82274c817cfd98a1
...
/usr/lib64/libgnome-desktop-3.so.19.0.8
