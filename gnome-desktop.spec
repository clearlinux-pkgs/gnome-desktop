...
Version  : 3.34.1
Release  : 40
URL      : https://download.gnome.org/sources/gnome-desktop/3.34/gnome-desktop-3.34.1.tar.xz
Source0  : https://download.gnome.org/sources/gnome-desktop/3.34/gnome-desktop-3.34.1.tar.xz
...
%prep
%setup -q -n gnome-desktop-3.34.1
%patch1 -p1
%patch2 -p1
%patch3 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570544370
